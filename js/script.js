  ...
  data: {
    ...
    datasets: [
      ...
      },
      {
        ...
        borderColor: "#d4870a",
        backgroundColor: "rgba(212,135,10,0.06)",
        fill: true,
        tension: 0.42,
        borderWidth: 1.8,
      ...
      },
      {
        ...
        borderColor: "#4a8fa8",
        backgroundColor: "rgba(74,143,168,0.06)",
        fill: false,
        tension: 0.42,
        borderWidth: 1.8,
        pointBackgroundColor: "#4a8fa8",
        pointRadius: 3,
        pointHoverRadius: 6,
      },
      {
  ...
  options: {
    ...
    scales: {
      ...
      y: {
        ...
        title: {
          display: true,
          text: "Estimasi Populasi (Orangutan & Gajah ÷10)",
...
new Chart(document.getElementById("causesChart").getContext("2d"), {
  ...
  options: {
    ...
    plugins: {
      ...
      tooltip: {
        callbacks: {
          label: (ctx) => ` ${ctx.raw}% kontribusi ancaman`,
          footer: () =>
            "Sumber: BKSDA RI 2023 · KLHK RI · WWF Indonesia · Traffic Intl",
        },
      },
    },
  },
...
new Chart(document.getElementById("regionalChart").getContext("2d"), {
  ...
  data: {
    ...
    datasets: [
      {
        label: "Mamalia (CR+EN+VU)",
        data: [54, 49, 22, 35, 28, 14, 10],
        backgroundColor: "rgba(192,57,43,0.75)",
        borderRadius: 2,
      },
      {
        label: "Burung (CR+EN+VU)",
        data: [38, 32, 24, 42, 61, 26, 22],
        backgroundColor: "rgba(74,143,168,0.70)",
        borderRadius: 2,
      },
      {
        label: "Reptil & Amfibi (CR+EN+VU)",
        data: [22, 18, 16, 27, 19, 11, 8],
  ...
  options: {
    ...
    plugins: {
      ...
      tooltip: {
        callbacks: {
          label: (ctx) => ` ${ctx.raw} spesies`,
          footer: () =>
            "Sumber: IUCN Red List 2024 · BRIN · Kementerian LHK 2023",
        },
      },
    },
    scales: {
      ...
      y: {
        ...
        title: {
          display: true,
          text: "Jumlah Spesies Terancam (CR + EN + VU)",
          color: "rgba(245,242,236,0.2)",
          font: { ...chartFont, size: 9 },
        },
      },
...
new Chart(document.getElementById("recoveryChart").getContext("2d"), {
  ...
  data: {
    ...
    datasets: [
      {
        label: "Tutupan Hutan Primer Tersisa (juta ha)",
        data: [32.5, 22.8, 11.4, 7.8, 4.2, 1.6, 0.7],
        backgroundColor: "rgba(61,139,61,0.72)",
        borderRadius: 2,
      },
      {
        label: "Kehilangan Hutan 2000–2023 (juta ha)",
        data: [3.2, 9.4, 8.8, 1.9, 0.6, 0.4, 0.3],
  ...
  options: {
    ...
    plugins: {
      ...
      tooltip: {
        callbacks: {
          label: (ctx) => ` ${ctx.raw} juta ha`,
          footer: () =>
            "Sumber: KLHK RI 2023 · FWI 2023 · Global Forest Watch 2024",
        },
      },
    },
    scales: {
...
// ===== MAP DOT INTERACTIONS (simple circles in SVG) =====
document.querySelectorAll(".map-point").forEach((point) => {
  ...
  point.addEventListener("mouseenter", function () {
    ...
    document.getElementById("popupName").textContent = name;
    document.getElementById("popupPop").innerHTML =
      `<strong style="color:rgba(245,242,236,.5);font-size:.68rem;letter-spacing:1px;text-transform:uppercase">Satwa Endemik</strong><br>${pop}`;
    document.getElementById("popupRisk").innerHTML =
      `<strong style="color:rgba(245,242,236,.5);font-size:.68rem;letter-spacing:1px;text-transform:uppercase">Tingkat Risiko</strong><br>${risk}`;
    popup.classList.add("visible");
  });

  point.addEventListener("mouseleave", () => popup.classList.remove("visible"));

  point.addEventListener("mousemove", function (e) {
    const rect = mapContainer.getBoundingClientRect();
    let px = e.clientX - rect.left + 18;
    let py = e.clientY - rect.top + 12;
    if (px + 240 > rect.width) px -= 258;
    popup.style.left = px + "px";
    popup.style.top = py + "px";
  });
});
...
const animalData = {
  "Harimau Sumatera": {
    ...
    status: "critical",
    statusLabel: "Kritis Terancam Punah",
    emoji: "🐅",
    population: "~400–600 ekor",
    habitat: "Hutan dataran rendah Sumatera",
    threats: "Deforestasi, perburuan liar, konflik manusia-satwa",
    conservation:
      "Taman Nasional Gunung Leuser, Kerinci Seblat, Bukit Barisan Selatan",
  ...
  "Badak Jawa": {
    ...
    iucn: "CR (Critically Endangered)",
    trend: "Stabil (sangat kecil)",
    img: "assets/img/badakjawa.jpg",
  },
  "Orangutan Sumatera": {
    ...
    statusLabel: "Kritis Terancam Punah",
    emoji: "🦧",
    population: "~13.846 ekor",
    habitat: "Hutan hujan Sumatera bagian utara (Aceh & Sumatera Utara)",
    threats:
      "Deforestasi perkebunan kelapa sawit, perdagangan satwa ilegal, kebakaran hutan",
    ...
    iucn: "CR (Critically Endangered)",
    trend: "Menurun",
    img: "assets/img/orangutansumatera.jpg",
  },
  "Gajah Sumatera": {
    ...
    statusLabel: "Kritis Terancam Punah",
    emoji: "🐘",
    population: "~1.700 ekor",
    habitat: "Hutan dataran rendah Sumatera, terutama Riau, Lampung, Aceh",
    threats: "Fragmentasi habitat, konflik dengan manusia, perburuan gading",
    conservation:
      "Flying Squad BKSDA, koridor satwa Tesso Nilo–Bukit Tigapuluh",
    ...
    iucn: "CR (Critically Endangered)",
    trend: "Menurun pesat",
    img: "assets/img/gajahsumatera.jpg",
  },
  "Jalak Bali": {
    ...
    statusLabel: "Kritis Terancam Punah",
    emoji: "🕊️",
    population: "~100 ekor liar (+ populasi penangkaran)",
    habitat: "Taman Nasional Bali Barat",
    threats: "Perburuan untuk perdagangan burung hias, habitat sempit",
    conservation:
      "Program penangkaran BTNBB, pelepasliaran rutin sejak 1990-an",
    ...
    img: "assets/img/jalakbali.jpg",
  },
  Komodo: {
    scientific: "Varanus komodoensis",
    status: "endangered",
    statusLabel: "Terancam Punah",
    emoji: "🦎",
    population: "~3.000–3.500 ekor",
    habitat: "Pulau Komodo, Rinca, Flores (Nusa Tenggara)",
    threats:
      "Kenaikan permukaan laut, penurunan mangsa, pariwisata tidak terkendali",
    ...
    iucn: "EN (Endangered)",
    trend: "Rentan terhadap perubahan iklim",
    img: "assets/img/komodo.jpg",
  },
};
...
function openAnimalModal(cardEl) {
  ...
  const statusClass =
    data.status === "critical" ? "status-critical" : "status-endangered";

  modal.querySelector(".amodal-img").src = data.img;
  modal.querySelector(".amodal-img").alt = name;
  modal.querySelector(".amodal-status").className =
    `animal-status ${statusClass} amodal-status`;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Add click listeners to animal cards
