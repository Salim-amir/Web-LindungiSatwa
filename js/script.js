...
function submitReport(btn) {
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      if (ut)
        ut.innerHTML = `Klik untuk unggah foto atau seret &amp; lepas<br/><span style="color:rgba(245,242,236,0.25);font-size:.72rem">PNG, JPG hingga 10MB</span>`;
    }, 3500);
  }, 1400);
}
